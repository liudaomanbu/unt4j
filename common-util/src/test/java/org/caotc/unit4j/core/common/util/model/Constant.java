...
public class Constant {
    ...
    static {
        try {
            ...
            CHILDREN_LONG_FIELD_OBJECT_STRING_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(STRING_FIELD_OBJECT_STRING_FIELD);
            CHILDREN_LONG_FIELD_OBJECT_LONG_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(CHILDREN_LONG_FIELD_OBJECT_LONG_FIELD);
            ...
            DUPLICATE_NUMBER_FIELD_SET_METHOD_OBJECT_PROPERTY_WRITERS = DUPLICATE_NUMBER_FIELD_SET_METHOD_OBJECT_SET_METHODS.stream().map(method -> PropertyWriter.<DuplicateNumberFieldSetMethodObject, Number>from(method, "numberField")).collect(ImmutableSet.toImmutableSet());
            FINAL_FIELD_OBJECT_STRING_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(FINAL_FIELD_OBJECT_STRING_FIELD);
            MULTIPLE_FIELD_OBJECT_STRING_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(MULTIPLE_FIELD_OBJECT_STRING_FIELD);
            MULTIPLE_FIELD_OBJECT_INTEGER_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(MULTIPLE_FIELD_OBJECT_INTEGER_FIELD);
            MULTIPLE_FIELD_OBJECT_INT_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(MULTIPLE_FIELD_OBJECT_INT_FIELD);
            MULTIPLE_FIELD_OBJECT_BOOLEAN_FIELD_PROPERTY_ACCESSOR = PropertyAccessor.from(MULTIPLE_FIELD_OBJECT_BOOLEAN_FIELD);
