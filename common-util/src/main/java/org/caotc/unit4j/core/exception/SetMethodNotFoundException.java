...
public class SetMethodNotFoundException extends IllegalArgumentException {
    ...
    private String messageInternal() {
        return String.format("%s not found the set Method for %s and the argument is %s", type(), propertyName(), propertyType());
    }
