...
public class Provider {
    static Stream<Arguments> inverseAndResults() {
        ...
        return Stream.of(
                ...
                Arguments.of(UnitType.builder().componentToExponent(UnitTypes.LENGTH, exponent).build(), UnitType.builder().componentToExponent(UnitType.builder().componentToExponent(UnitTypes.LENGTH, exponent).build(), -1).build()),
                Arguments.of(UnitType.builder().componentToExponent(UnitTypes.ENERGY_WORK_HEAT_QUANTITY, exponent).build(), UnitType.builder().componentToExponent(UnitType.builder().componentToExponent(UnitTypes.ENERGY_WORK_HEAT_QUANTITY, exponent).build(), -1).build())
        );
    }
