...
//                Arguments.of(Unit.builder().componentToExponent(UnitConstant.JOULE, exponent).build(), Unit.builder().componentToExponents(Maps.transformValues(UnitConstant.JOULE.componentToExponents(), value -> value * exponent)).build())
    ...
    static Stream<Arguments> originalAndRecursiveAndSimplifieds() {
        ...
        return Stream.concat(recursiveEqualedOriginalAndSimplifieds()
                ...
                Stream.of(
//                        Arguments.of(Unit.builder().componentToExponent(UnitConstant.NEWTON.multiply(UnitConstant.METER), -1).build(), true, Unit.builder().componentToExponent(UnitConstant.KILOGRAM, -1).componentToExponent(UnitConstant.METER, -2).componentToExponent(UnitConstant.SECOND, 2).build()),
                        Arguments.of(Unit.builder().componentToExponent(UnitConstant.NEWTON.multiply(UnitConstant.METER), -1).build(), false, Unit.builder().componentToExponent(UnitConstant.NEWTON, -1).componentToExponent(UnitConstant.METER, -1).build()),
                        Arguments.of(Unit.builder().componentToExponent(UnitConstant.NEWTON.multiply(UnitConstant.METER), exponent).build(), true, Unit.builder().componentToExponent(UnitConstant.KILOGRAM, exponent).componentToExponent(UnitConstant.METER, 2 * exponent).componentToExponent(UnitConstant.SECOND, -2 * exponent).build()),
                        Arguments.of(Unit.builder().componentToExponent(UnitConstant.NEWTON.multiply(UnitConstant.METER), exponent).build(), false, Unit.builder().componentToExponent(UnitConstant.NEWTON, exponent).componentToExponent(UnitConstant.METER, exponent).build())
                ));
    }
}