...
public class UnitConstant {
   ...
   */
  public static final Unit NON = Unit.builder().build();

  /**
   * 赫兹 s−1
   */
  public static final Unit HERTZ = Unit.builder()
          .componentToExponent(UnitConstant.SECOND, -1).build();

  /**
   * 牛顿 kg·m·s−2 力 重量
   */
  public static final Unit NEWTON = Unit.builder()
   ...
   */
  public static final Unit PASCAL = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
                  UnitConstant.METER, -1)
          .componentToExponent(UnitConstant.SECOND, -2).build();
   ...
   */
  public static final Unit JOULE = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
   ...
   */
  public static final StandardUnit WATT = new CompositeStandardUnit(ImmutableMap.<Unit, Integer>builder()
          .put(UnitConstant.KILOGRAM, 1)
          .put(UnitConstant.METER, 2)
          .put(UnitConstant.SECOND, -3)
          .build());

  /**
   * 库仑 s·A 电荷
   */
  public static final Unit COULOMB = Unit.builder()
   ...
   */
  public static final Unit VOLT = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
                  UnitConstant.METER, 2)
   ...
   */
  public static final Unit FARAD = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, -1).componentToExponent(
                  UnitConstant.METER, -2)
   ...
   */
  public static final Unit OHM = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
                  UnitConstant.METER, 2)
          .componentToExponent(UnitConstant.SECOND, -3)
   ...
   */
  public static final Unit SIEMENS = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, -1).componentToExponent(
                  UnitConstant.METER, -2)
          .componentToExponent(UnitConstant.SECOND, 3)
          .componentToExponent(UnitConstant.AMPERE, 2)
   ...
   */
  public static final Unit WEBER = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
                  UnitConstant.METER, 2)
   ...
   */
  public static final Unit TESLA = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
   ...
   */
  public static final Unit HENRY = Unit.builder()
          .componentToExponent(UnitConstant.KILOGRAM, 1).componentToExponent(
                  UnitConstant.METER, 2)
          .componentToExponent(UnitConstant.SECOND, -2)
          .componentToExponent(UnitConstant.AMPERE, -2).build();
   ...
   * 流明 cd·sr	cd 光通量
   */
  public static final Unit LUMEN = Unit.builder()
   ...
   * 勒克斯 lm/m2	m−2·cd 照度
   */
  public static final Unit LUX = Unit.builder()
   ...
   * 贝克勒尔 s−1 放射性活度
   */
  public static final Unit BECQUEREL = Unit.builder()
          .componentToExponent(UnitConstant.SECOND, -1).build();

  /**
   * 戈瑞 J/kg	m2·s−2 致电离辐射的吸收剂量
   */
  public static final Unit GRAY = Unit.builder()
          .componentToExponent(UnitConstant.METER, 2)
          .componentToExponent(UnitConstant.SECOND, -2)
          .build();
   ...
   */
  public static final Unit SIEVERT = Unit.builder()
          .componentToExponent(UnitConstant.METER, 2)
          .componentToExponent(UnitConstant.SECOND, -2)
          .build();
   ...
   * 开特 mol·s−1 催化活度
   */
  public static final Unit KATAL = Unit.builder()
